...
export const insightX: Project = {
  slug: "insight-x",
  title: "Insight-X",
  tagline: "AI business analytics for MedSpas — generates custom dashboards from any data shape.",
  ...
  outcome:
    "The platform demonstrated enough traction to help the company close $250k in funding. Operators got live dashboards for revenue, booking analytics, provider performance, and client retention in a single interface — without ever touching a query.",
